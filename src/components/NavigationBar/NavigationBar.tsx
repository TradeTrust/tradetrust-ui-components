      ...
      <div className={`container py-2`}>
        <div className="relative flex items-center justify-center">
          <div className="lg:hidden absolute left-0">
            ...
            >
              <span className="w-full bg-pale-sky-grey-500 transition-transform duration-200 ease-out absolute block top-bar" />
              <span className="w-full bg-pale-sky-grey-500 transition-transform duration-200 ease-out absolute block bottom-bar" />
            </button>
          </div>
