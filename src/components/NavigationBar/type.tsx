...
interface DropDownList extends Omit<NavigationLink, "schema"> {
...
export const NavigationBarItem: FunctionComponent<{ item: NavigationItem; onClick: (isOn: boolean) => void }> = ({
  item,
  onClick,
}) => {
  switch (item.schema) {
