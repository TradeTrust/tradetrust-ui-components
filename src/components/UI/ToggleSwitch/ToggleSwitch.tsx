 ...
 * changes
 */
export const ToggleSwitch: FunctionComponent<ToggleProps> = ({
  isOn,
  handleToggle,
}) => {
  return (
    ...
    >
      <div className="relative">
        ...
        <div
          className={`block ${
            isOn ? `bg-forest-500` : `bg-cloud-200`
          } w-16 h-8 rounded-2xl`}
        />
        <div
        ...
        <div
          className={`text-sm absolute top-1.5 right-1.5 text-white${
            isOn ? " hidden" : ""
          }`}
        >
          OFF
        ...
        <div
          className={`text-sm absolute top-1.5 left-1.5 text-white${
            isOn ? "" : " hidden"
          }`}
        >
          ON
