...
export const ButtonDefault = (): ReactElement => {
  return (
    <Dropdown
      ...
      className="rounded px-3 py-2 font-redhatdisplay font-bold text-white bg-tangerine-500 hover:bg-tangerine-800"
    >
      <DropdownItem
...
export const NavBarDefault = (): ReactElement => {
  return (
    <Dropdown
      ...
      className="font-redhatdisplay font-bold text-cloud-300 hover:none"
    >
