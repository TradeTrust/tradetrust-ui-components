...
const ButtonClose: FunctionComponent = () => {
  ...
  return (
    <Button className="bg-cerulean-500 rounded-xl text-white px-3 py-2 hover:bg-cerulean-300" onClick={closeOverlay}>
      Dismiss
    </Button>
  );
};
...
const ButtonMetamaskInstall: FunctionComponent = () => {
  return (
    <LinkButton
      className="bg-cerulean-500 rounded-xl text-white hover:bg-cerulean-300"
