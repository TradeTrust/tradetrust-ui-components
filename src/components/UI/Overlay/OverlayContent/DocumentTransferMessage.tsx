...
const ButtonClose: FunctionComponent = () => {
  ...
  return (
    <Button className="bg-orange-500 text-white hover:bg-orange-600" onClick={handleCloseOverlay}>
      Close
    </Button>
  );
};
...
const ButtonConfirmAction = (handleOnClick: () => void): ReactNode => {
  ...
  return (
    <Button className="bg-orange-500 text-white hover:bg-orange-600" onClick={onClick} data-testid={"confirmActionBtn"}>
      Confirm
    </Button>
  );
};
