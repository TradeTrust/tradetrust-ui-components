...
describe("addressBookLocal", () => {
  it("should show default message", () => {
    ...
    render(<AddressBookLocal onAddressSelect={() => {}} filteredLocalAddresses={[]} network="local" />);
  ...
  it("should show correct result when address is searched", () => {
    ...
    render(
      <AddressBookLocal onAddressSelect={() => {}} filteredLocalAddresses={filteredLocalAddresses} network="local" />
    );
